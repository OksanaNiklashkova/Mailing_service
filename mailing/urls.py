...
urlpatterns = [
    ...
    path(
        "message_edit/<int:pk>/", views.MessageUpdateView.as_view(), name="message_edit"
    ),
    path(
    ...
    path(
        "mailing_edit/<int:pk>/", views.MailingUpdateView.as_view(), name="mailing_edit"
    ),
    path(
    ...
    path(
        "send_attempt_list/",
        views.SendAttemptListView.as_view(),
        name="send_attempt_list",
    ),
    path(
        "send_attempt/<int:pk>/",
        views.SendAttemptDetailView.as_view(),
        name="send_attempt",
    ),
    path(
        "send_mailing/<int:pk>/", views.SendMailingView.as_view(), name="send_mailing"
    ),
]
